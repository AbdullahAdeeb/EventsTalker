...
.config(['$routeProvider', 'SECURED_ROUTES', function($routeProvider, SECURED_ROUTES) {
  ...
  //
  $routeProvider.otherwiseWarn = function(redirectObj) {
    // alert("Page not found, Going Home!");
    console.log($routeProvider);
    this.otherwise(redirectObj);
  };
...
.config(['$routeProvider', function($routeProvider) {
  $routeProvider
    ...
    .whenAuthenticated('/event/:roomId', {
